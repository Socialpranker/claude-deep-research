...
Thank you for considering a contribution. This skill is most valuable when its **catalog of sources and channels grows** — the world has thousands more sources than the current 280+, and you might know exactly the right one for a specific industry or methodology.
...
The block library has 75 blocks but specific use cases might need more.
...
Open a [discussion](https://github.com/ivanterescheenko-ai/claude-deep-research/discussions) or [issue](https://github.com/ivanterescheenko-ai/claude-deep-research/issues).
