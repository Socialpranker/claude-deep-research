...
<!--gen:count:blocks-->76<!--/gen--> блоков в 10 категориях. Композируемые секции для финального отчёта.
...
## Полная таблица всех <!--gen:count:blocks-->76<!--/gen--> блоков
...
При <!--gen:count:blocks-->76<!--/gen--> блоках критично не загружать всё в контекст.
